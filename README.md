...
| **Right-Click Search**        | Select text anywhere in any tab -> Right Click -> Search on Moctale |
...
|          Feature         |         Description                                     |
|:-------------------------|:--------------------------------------------------------|
| **SideBar Plus**         | Adds a sideBar with three sections containing well-organized platforms and tools |
| **Collection Export**    | One-click ZIP Bundle export for currently opened collection in CSV,  |
| **Tier List Maker**      | Make Tier Lists of from currently opened collections with TierMaker.com |
| **Random Picker**        | Picks random title from currently opened collection | 
...
| **Private Notes**        | Write privates notes for all Titles |
...
- [@facebook/react](https://github.com/facebook/react) - powering the core UI of Moctale Plus.
...
- [@FortAwesome/fontawesome-svg-core](https://github.com/FortAwesome/Font-Awesome), [@lusaxweb/iconsax-react](https://github.com/lusaxweb/iconsax-react), [@lucide-icons/lucide](https://github.com/lucide-icons/lucide) and [react-icons](https://github.com/react-icons/react-icons) - comprehensive icon support.
