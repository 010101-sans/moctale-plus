import { r as reactExports, ao as confetti, j as jsxRuntimeExports, ap as Global, aq as Flash, ar as MagicStar, as as Refresh, at as Import, au as UserSquare, av as Logout, aw as Setting2, ax as Image, ay as BrushSquare, az as ChartSquare, f as TickCircle, aA as CloudChange, aB as Export, aC as Code, aD as Heart, aE as CloseSquare, aF as ArrowDown2, aG as Minus, aH as Add, a as clientExports } from "./vendor-C8JjCdYh.js";
import { u as useSettings, D as DEFAULT_PAINTER_COLORS, R as REPO_OWNER, a as REPO_NAME, C as CURRENT_VERSION, s as showToast, A as AutoBackupSettings, e as exportBackup, i as importBackup } from "./index.tsx-BtOdhFfW.js";
...
const ColorPickerItem = ({ label, value, onChange }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "div",
  {
    style: {
      display: "flex",
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "11px", color: "#ccc", fontWeight: 500, letterSpacing: "0.02em" }, children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "12px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "10px", color: "#666", fontFamily: "monospace", textTransform: "uppercase" }, children: value }),
...
function App() {
  ...
  const [painterColors, setPainterColors] = reactExports.useState(DEFAULT_PAINTER_COLORS);
  ...
  reactExports.useEffect(() => {
    if (showCelebration) {
      ...
      (function frame() {
        confetti({ particleCount: 5, angle: 60, spread: 50, origin: { x: 0 }, colors: [randomColor()], zIndex: 100 });
        confetti({ particleCount: 5, angle: 120, spread: 50, origin: { x: 1 }, colors: [randomColor()], zIndex: 100 });
  ...
  reactExports.useEffect(() => {
    const initData = async () => {
      chrome.storage.local.get(["cachedUserProfile", "spoilerKeywords", "themePainterColors"], (items) => {
        const result = items;
        if (result.cachedUserProfile) setUserProfile(result.cachedUserProfile);
        if (result.spoilerKeywords) setSpoilerKeywords(result.spoilerKeywords);
        else setSpoilerKeywords(DEFAULT_KEYWORDS);
        if (result.themePainterColors) setPainterColors(result.themePainterColors);
      });
      try {
  ...
  const updatePainterColor = (key, val) => {
    const newColors = { ...painterColors, [key]: val };
    setPainterColors(newColors);
    chrome.storage.local.set({ themePainterColors: newColors });
  };
  const resetPainter = () => {
    setPainterColors(DEFAULT_PAINTER_COLORS);
    chrome.storage.local.set({ themePainterColors: DEFAULT_PAINTER_COLORS });
  ...
  const handleCloudSync = async () => {
    ...
    showToast("Syncing with Google Drive...", "loading");
    try {
      const profile = await GoogleDriveService.getUserProfile();
      setUserProfile(profile);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", minHeight: "100vh", background: "#050505", color: "#ffffff", fontFamily: "Inter, system-ui, sans-serif" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
        ...
        .footer .footer-btn.sync:hover { color: #22d3ee !important; border-color: #22d3ee !important; background: rgba(34, 211, 238, 0.1) !important; box-shadow: 0 0 12px rgba(34, 211, 238, 0.3) !important; }
        .footer .footer-btn.auto-backup-btn:hover { color: #22d3ee !important; border-color: #22d3ee !important; background: rgba(34, 211, 238, 0.1) !important; box-shadow: 0 0 12px rgba(34, 211, 238, 0.3) !important; }
        .footer .footer-btn.import:hover { color: #4ade80 !important; border-color: #4ade80 !important; background: rgba(74, 222, 128, 0.1) !important; box-shadow: 0 0 12px rgba(74, 222, 128, 0.3) !important; }
        .footer .footer-btn.export:hover { color: #facc15 !important; border-color: #facc15 !important; background: rgba(250, 204, 21, 0.1) !important; box-shadow: 0 0 12px rgba(250, 204, 21, 0.3) !important; }
        .footer .footer-btn.github:hover { color: #c084fc !important; border-color: #c084fc !important; background: rgba(192, 132, 252, 0.1) !important; box-shadow: 0 0 12px rgba(192, 132, 252, 0.3) !important; }
        .footer .footer-btn.support:hover { color: #f472b6 !important; border-color: #f472b6 !important; background: rgba(244, 114, 182, 0.1) !important; box-shadow: 0 0 12px rgba(244, 114, 182, 0.3) !important; }

        .footer-stack { display: flex; flex-direction: column; gap: 12px; width: 100%; }
        .footer-row-split { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; width: 100%; }
        .split-btn-container { display: grid; grid-template-columns: 1fr 48px; gap: 12px; width: 100%; }
        ...
        .user-avatar-btn img { width: 100%; height: 100%; object-fit: cover; border-radius: 7px; }
        .user-avatar-btn:hover { border-color: #ef4444; background: rgba(239, 68, 68, 0.2); box-shadow: 0 0 8px rgba(239, 68, 68, 0.4); }
        .user-avatar-btn:hover .avatar-img { opacity: 0; }
        .user-avatar-btn .logout-icon { position: absolute; opacity: 0; transition: opacity 0.2s; }
        .user-avatar-btn:hover .logout-icon { opacity: 1; }

        .split-btn-container { display: grid; grid-template-columns: 48px 1fr 48px; gap: 8px; width: 100%; height: 42px; }
      ...
      .celebration-banner {
        ...
        overflow: hidden;
        isolation: isolate;
        background: linear-gradient(120deg, #312e81, #7c3aed, #facc15, #831843);
        background-size: 300% 300%;
        animation: slideIn 0.5s ease-out, gradientShift 6s ease infinite;
        box-shadow: 0 6px 25px rgba(124, 58, 237, 0.35), inset 0 0 20px rgba(255, 255, 255, 0.05);
      }
      ...
      .celebration-banner::after {
        ...
        position: absolute;
        inset: 0;
        background-image: radial-gradient(#fff 1px, transparent 1px), radial-gradient(#fde047 1px, transparent 1px);
      ...
      @keyframes sparkleMove { from { transform: translateY(0); } to { transform: translateY(-40px); } }
        ...
        .celebration-content { position: relative; z-index: 10; display: flex; align-items: center; justify-content: space-between; }
        .celebration-title { font-size: 10px; font-weight: 700; color: #fde047; text-transform: uppercase; letter-spacing: 0.1em; display: block; margin-bottom: 2px; }
        .celebration-year { font-size: 20px; font-weight: 800; color: white; line-height: 1; }

        .celebration-btn {
          position: relative; z-index: 10; padding: 12px 14px; font-size: 12px; font-weight: 700; letter-spacing: 0.04em;
          border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.25); color: #ffffff;
          background: linear-gradient(270deg, #fde047, #7c3aed, #312e81); background-size: 300% 300%;
          animation: buttonGradientShift 6s ease infinite; cursor: pointer;
          box-shadow: 0 4px 10px rgba(0,0,0,0.25), inset 0 0 6px rgba(255,255,255,0.25);
          transition: transform 0.15s ease, box-shadow 0.15s ease;
        }

        @keyframes buttonGradientShift { 0% { background-position: 100% 50%; } 50% { background-position: 0% 50%; } 100% { background-position: 100% 50%; } }

        .celebration-btn:hover { transform: translateY(-1px); box-shadow: 0 6px 16px rgba(0,0,0,0.35), inset 0 0 10px rgba(255,255,255,0.35); }
        .celebration-btn:active { transform: translateY(0); box-shadow: 0 3px 8px rgba(0,0,0,0.3), inset 0 0 4px rgba(255,255,255,0.2); }
        .celebration-bg { position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-image: radial-gradient(white 1px, transparent 1px); background-size: 20px 20px; opacity: 0.1; }
        ...
        .header-link-btn {
          ...
          color: #a1a1aa; transition: all 0.2s ease;
        }
        .header-link-btn:hover { color: #ffffff; border-color: rgba(255,255,255,0.25); background: rgba(255,255,255,0.12); }
        ...
        .header-link-btn {
          ...
          color: #d4d4d8 !important; fill: currentColor !important; stroke: currentColor !important;
          opacity: 1 !important; visibility: visible !important; transition: all 0.2s ease;
        }
        .header-link-btn svg { display: block; }
        .header-link-btn:hover { color: #ffffff !important; border-color: rgba(255,255,255,0.3); background: rgba(255,255,255,0.15); }
      ` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-right", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: openOfficialSite, title: "Visit Official Website", className: "header-link-btn", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Global, { size: "16", variant: "Linear" }) }),
        updateAvailable ? /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `https://github.com/${REPO_OWNER}/${REPO_NAME}/releases/latest`, target: "_blank", rel: "noopener noreferrer", className: "update-badge", title: `New version ${updateAvailable} available!`, children: [
    ...
    showCelebration && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "celebration-banner", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "celebration-content", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: openOfficialSite, className: "celebration-btn", children: "Official Website" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", style: { flex: 1, paddingBottom: "30px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Enhancements", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ToolIcon, {}), isOpen: openSection === "utils", onToggle: () => toggleSection("utils"), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Linkifier", desc: "Make raw text links clickable", checked: settings.enableLinkifier, onChange: (val) => updateSetting("enableLinkifier", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Advanced Spoiler Shield", desc: "Blur spoilers in reviews & posts", checked: settings.enableSpoilerShield, onChange: (val) => updateSetting("enableSpoilerShield", val) }),
        settings.enableSpoilerShield && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "keyword-section", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { className: "keyword-textarea", value: spoilerKeywords, onChange: handleKeywordChange, placeholder: "die, killed, ending, twist...", spellCheck: false })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Review Templates", desc: "Helper dropdown in review box", checked: settings.enableReviewTemplates, onChange: (val) => updateSetting("enableReviewTemplates", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Context Menu", desc: "Right-click to search Moctale", checked: settings.enableContextMenu, onChange: (val) => updateSetting("enableContextMenu", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Flash, { size: "18", variant: "Bold", className: "text-yellow-400" }), label: "Performance Max", desc: "Instant loads & smooth scroll", checked: settings.enablePerformanceMax, onChange: (val) => updateSetting("enablePerformanceMax", val) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Theme & Visuals", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PaintIcon, {}), isOpen: openSection === "visuals", onToggle: () => toggleSection("visuals"), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MagicStar, { size: "18", variant: "Bold", className: "text-purple-400" }), label: "Dynamic Theming", desc: "Adapt colors to movie posters", checked: settings.enableDynamicTheme, onChange: (val) => updateSetting("enableDynamicTheme", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SelectItem,
          {
            label: "Active Theme",
            ...
            onChange: (val) => {
              updateSetting("activeTheme", val);
              showToast(`Theme set to ${val}`, "success");
            },
            options: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/5 my-2 pt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ToggleItem,
            {
              label: "Theme Painter",
              desc: "Design your own color scheme",
              checked: settings.enableThemePainter,
              onChange: (val) => updateSetting("enableThemePainter", val)
            }
          ),
          settings.enableThemePainter && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
            display: "flex",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "10px", fontWeight: 700, color: "#888", textTransform: "uppercase", letterSpacing: "0.05em" }, children: "Palette Editor" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: resetPainter,
                  style: {
                    padding: "4px",
                    color: "#666",
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Refresh, { size: "12", variant: "Bold" })
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ColorPickerItem, { label: "Background Base", value: painterColors.bgBase, onChange: (v) => updatePainterColor("bgBase", v) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ColorPickerItem, { label: "Surface Cards", value: painterColors.bgSurface, onChange: (v) => updatePainterColor("bgSurface", v) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ColorPickerItem, { label: "Hover / Layers", value: painterColors.bgLayer, onChange: (v) => updatePainterColor("bgLayer", v) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ColorPickerItem, { label: "Borders", value: painterColors.border, onChange: (v) => updatePainterColor("border", v) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ColorPickerItem, { label: "Primary Text", value: painterColors.textMain, onChange: (v) => updatePainterColor("textMain", v) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ColorPickerItem, { label: "Muted Text", value: painterColors.textMuted, onChange: (v) => updatePainterColor("textMuted", v) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ColorPickerItem, { label: "Accent Color", value: painterColors.accent, onChange: (v) => updatePainterColor("accent", v) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/5 pt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          StepperItem,
          {
            ...
            onChange: (val) => {
              ...
              let text = `${val} Columns`;
              if (val === 0) text = "Default Grid";
              if (val === 1) text = "List View";
              showToast(`Layout: ${text}`, "success");
            },
            formatLabel: (v) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Stats & Data", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartIcon, {}), isOpen: openSection === "data", onToggle: () => toggleSection("data"), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "SideBar Plus", desc: "Platforms, Community & Production", checked: settings.enableSideBar, onChange: (val) => updateSetting("enableSideBar", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Export Collections", desc: "Enable CSV export button", checked: settings.enableCollectionExport, onChange: (val) => updateSetting("enableCollectionExport", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Pick Random Content", desc: "Shuffle button for collections", checked: settings.enablePickRandom, onChange: (val) => updateSetting("enablePickRandom", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Episode Tracker", desc: "Track watched episodes per season", checked: settings.enableEpisodeTracker, onChange: (val) => updateSetting("enableEpisodeTracker", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Search Plus", desc: "External search buttons", checked: settings.enableSearchPlus, onChange: (val) => updateSetting("enableSearchPlus", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Private Notes", desc: "Local text editor for content", checked: settings.enablePrivateNotes, onChange: (val) => updateSetting("enablePrivateNotes", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Image Preview", desc: "Hover images to enlarge", checked: settings.enableImagePreview, onChange: (val) => updateSetting("enableImagePreview", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Import, { size: "18", variant: "Bold", className: "text-cyan-400" }), label: "Image Downloader", desc: "Hover image to download", checked: settings.enableImageDownloader, onChange: (val) => updateSetting("enableImageDownloader", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Watch Status", desc: "Show watched indicator on posters", checked: settings.enableWatchStatus, onChange: (val) => updateSetting("enableWatchStatus", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Local Tracker", desc: "Builds a private & local database.", checked: settings.enableLocalTracker, onChange: (val) => updateSetting("enableLocalTracker", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { label: "Graph View", desc: "Obsidian inspired graph view", checked: settings.enableGraphView, onChange: (val) => updateSetting("enableGraphView", val) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(UserSquare, { size: "18", variant: "Bold", className: "text-violet-400" }), label: "Familiar Faces", desc: "Highlight known cast & crew", checked: settings.enableFamiliarFaces, onChange: (val) => updateSetting("enableFamiliarFaces", val) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer", style: { padding: "0 20px 24px 20px", background: "transparent", marginTop: "auto", borderTop: "none" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-stack", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: "100%", marginBottom: "10px" }, children: userProfile ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "split-btn-container", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handleCloudSync, className: `footer-btn sync ${syncStatus}`, title: "Sync Now", style: { height: "100%" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "user-avatar-btn", onClick: handleSignOut, title: `Signed in as ${userProfile.name}. Click to Sign Out.`, children: [
        ...
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handleCloudSync, className: `footer-btn sync ${syncStatus}`, title: "Sign in with Google", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-row-split", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handleExport, className: "footer-btn export", title: "Export Backup", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(UploadIcon, {}),
            "Export"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-row-split", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `https://github.com/${REPO_OWNER}/${REPO_NAME}`, target: "_blank", rel: "noopener noreferrer", className: "footer-btn github", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(GithubIcon, {}),
            "GitHub"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setShowSupport(true), className: "footer-btn support", children: [
